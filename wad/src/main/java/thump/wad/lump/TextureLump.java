...
public class TextureLump extends Lump {
    ...
    public final ArrayList<MapTexture> textures = new ArrayList<>();
    ...
    public TextureLump(Wad wad, FileChannel fc, String name, int filepos, int size) throws IOException {
        ...
        wad.setTextures(textures);
    }
    
    private void ingest(Wad wad, FileChannel fc, int filepos, int size) throws IOException {
        fc.position(filepos);
        ...
        for (int i = 0; i < numTextures; i++) {
            textures.add(new MapTexture(bb));
        }        
    }
    ...
    public String toString() {
        ...
        sb.append("    numTextures:").append(textures.size());
        sb.append("\n");
        ...
        for (int i=0; i<textures.size(); i++) {
            ...
            sb.append(textures.get(i).toString());
            sb.append("\n");
        }
...
//        return textures.get(i).getImage();
//    }
}
