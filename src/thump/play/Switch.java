...
import static thump.play.Button.BWhere.BOTTOM;
import static thump.play.Button.BWhere.MIDDLE;
import static thump.play.Button.BWhere.TOP;
import static thump.play.Ceiling.Type.*;
import static thump.play.Floor.Type.*;
import static thump.play.Platform.Type.*;
import static thump.play.SpecialEffects.BUTTONTIME;
import static thump.play.SpecialEffects.MAXBUTTONS;
import static thump.play.SpecialEffects.MAXSWITCHES;
import static thump.play.SpecialEffects.Stair.*;
import static thump.play.VDoor.Type.blazeClose;
import static thump.play.VDoor.Type.blazeOpen;
import static thump.play.VDoor.Type.blazeRaise;
import static thump.play.VDoor.Type.close;
import static thump.play.VDoor.Type.normal;
import static thump.play.VDoor.Type.open;
import thump.render.Line;
import static thump.render.Line.ML_SECRET;
import thump.sound.Sound;
import thump.sound.sfx.Sounds.SfxEnum;
import static thump.sound.sfx.Sounds.SfxEnum.sfx_swtchn;
import static thump.sound.sfx.Sounds.SfxEnum.sfx_swtchx;
...
//    #endif
    ...
    void P_StartButton(
        ...
        SystemInterface.I_Error("P_StartButton: no button slots left!\n");
    }
