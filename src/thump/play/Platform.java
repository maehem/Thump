...
import static thump.play.Platform.Status.down;
import static thump.play.Platform.Status.in_stasis;
import static thump.play.Platform.Status.up;
import static thump.play.Platform.Status.waiting;
import static thump.play.Platform.Type.raiseAndChange;
...
import static thump.sound.sfx.Sounds.SfxEnum.sfx_pstart;
...
public class Platform implements Thinker {
    ...
    public static void P_AddActivePlat(Platform plat) {
        ...
        SystemInterface.I_Error ("P_AddActivePlat: no more plats!\n");
    }
    ...
    public static void P_RemoveActivePlat(Platform plat) {
        ...
        SystemInterface.I_Error ("P_RemoveActivePlat: can't find plat!\n");
    }
