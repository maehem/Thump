...
import static thump.global.State.StateNum.S_PLAY;
import static thump.global.State.StateNum.S_PLAY_RUN1;
        ...
        if ((cmd.buttons & BT_CHANGE)>0)
        {
                ...
                && newweapon != player.readyweapon)
            {
                ...
                if ((newweapon != wp_plasma
                     && newweapon != wp_bfg)
                    || (Game.getInstance().gameMode != Defines.GameMode.SHAREWARE) )
                {
