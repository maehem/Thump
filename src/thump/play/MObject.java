...
import static thump.global.Defines.MTF_AMBUSH;
...
import static thump.maplevel.MapObject.MobileObjectFlag.MF_AMBUSH;
import static thump.maplevel.MapObject.MobileObjectFlag.MF_CORPSE;
import static thump.maplevel.MapObject.MobileObjectFlag.MF_COUNTITEM;
import static thump.maplevel.MapObject.MobileObjectFlag.MF_COUNTKILL;
...
import static thump.maplevel.MapObject.MobileObjectFlag.MF_INFLOAT;
...
import static thump.maplevel.MapObject.MobileObjectFlag.MF_NOGRAVITY;
import static thump.maplevel.MapObject.MobileObjectFlag.MF_NOTDMATCH;
...
import static thump.maplevel.MapObject.MobileObjectFlag.MF_SPAWNCEILING;
...
import static thump.maplevel.MapObject.ONCEILINGZ;
import static thump.maplevel.MapObject.ONFLOORZ;
import thump.maplevel.MapThing;
import static thump.play.Local.FLOATSPEED;
import static thump.play.Local.GRAVITY;
import static thump.play.Local.MAXMOVE;
import static thump.play.Local.MELEERANGE;
import static thump.play.Local.VIEWHEIGHT;
import thump.render.Renderer;
import thump.render.SubSector;
import thump.sound.sfx.Sounds;
import static thump.sound.sfx.Sounds.SfxEnum.sfx_itmbk;
import static thump.sound.sfx.Sounds.SfxEnum.sfx_oof;
...
//            S_StartSound (mo, mo.info.deathsound);
    ...
    public static void P_SpawnMapThing (MapThing mthing) {
        ...
        if (i==mobjinfo.length) {
            SystemInterface.I_Error ("P_SpawnMapThing: Unknown type {0} at ({1}, {2})",
                    new Object[]{
                    mthing.type,
                    mthing.x, mthing.y}
            );
