...
public class Wad {
    ...
    public ArrayList<Color[]> paletteList = null;
    ...
    /** Finds normal picture/patch in top level lumps.
     *
     */
    Patch findPicture(short patchNum) {
    ...
    public Patch getPatchByName(String pName) {
        return patchesLump.getPatchByName(pName.toUpperCase());
    }
...
//        // TFB. Not found.
    ...
    public int W_GetNumForName (String name) {
        ...
        if (i == -1) {
            SystemInterface.I_Error ("W_GetNumForName: {0} not found!\n", new Object[]{name});
        }
