...
import static thump.global.Defines.AmmoType.am_clip;
import thump.global.Defines.GameMission;
import static thump.global.Defines.GameMission.pack_plut;
import static thump.global.Defines.GameMission.pack_tnt;
import thump.global.Defines.GameMode;
import static thump.global.Defines.GameState.GS_DEMOSCREEN;
import static thump.global.Defines.GameState.GS_FINALE;
import static thump.global.Defines.GameState.GS_INTERMISSION;
import static thump.global.Defines.GameState.GS_LEVEL;
import static thump.global.Defines.KEY_F12;
import static thump.global.Defines.KEY_PAUSE;
import static thump.global.Defines.MAXPLAYERS;
import thump.global.Defines.Skill;
import static thump.global.Defines.Skill.sk_nightmare;
import thump.global.Defines.WeaponType;
import static thump.global.Defines.WeaponType.wp_fist;
import static thump.global.Defines.WeaponType.wp_pistol;
...
import static thump.global.State.StateNum.S_SARG_PAIN2;
import static thump.global.State.StateNum.S_SARG_RUN1;
...
import static thump.global.ThingStateLUT.states;
import thump.global.VideoInterface;
import thump.headsup.Stuff;
...
import thump.menu.MenuMisc;
import thump.network.Net;
import static thump.network.Net.BACKUPTICS;
import static thump.play.Interaction.maxammo;
import static thump.play.Local.MAXHEALTH;
import thump.play.MObject;
import thump.play.Map;
import thump.play.Sight;
...
public class Game {
    ...
    public  final Things things = new Things(this);
    ...
    public  static ResourceBundle  messages = ResourceBundle.getBundle("thump.i18n.MessagesBundle", currentLocale);
...
//    #endif 
    ...
    public void G_Ticker () { 
        ...
        while (gameaction != GameAction.ga_nothing) { 
            switch (gameaction) { 
              case ga_loadlevel: 
        Defines.logger.config("G_Ticker ga_loadlevel\n");
                G_DoLoadLevel (); 
                break; 
              case ga_newgame: 
        Defines.logger.config("G_Ticker ga_newgame\n");
                G_DoNewGame (); 
                break; 
              case ga_loadgame: 
        Defines.logger.config("G_Ticker ga_loadgame\n");
//                G_DoLoadGame (); 
                break; 
              case ga_savegame: 
        Defines.logger.config("G_Ticker ga_savegame\n");
//                G_DoSaveGame (); 
                break; 
              case ga_playdemo: 
        Defines.logger.config("G_Ticker ga_playdemo\n");
                G_DoPlayDemo (); 
                break; 
              case ga_completed: 
        Defines.logger.config("G_Ticker ga_completed\n");
                G_DoCompleted (); 
                break; 
              case ga_victory: 
        Defines.logger.config("G_Ticker ga_victory\n");
//                F_StartFinale (); 
                break; 
              case ga_worlddone: 
        Defines.logger.config("G_Ticker ga_worlddone\n");
                G_DoWorldDone (); 
                break; 
              case ga_screenshot: 
        Defines.logger.config("G_Ticker ge screenshot\n");
                MenuMisc.screenShot(); 
...
//TODO            F_Ticker (); 
    ...
    boolean G_CheckSpot( int playernum, MapThing mthing ) { 
        ...
        ss = renderer.R_PointInSubsector (x,y); 
