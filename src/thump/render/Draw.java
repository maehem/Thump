...
//
    ...
    //    }
        ...
        int x = columnofs[dc_x];
        Screen dest = Game.getInstance().video.screens[0];
        byte[][] colormaps = Game.getInstance().renderer.data.colormaps;
...
//    #endif 
    ...
    public void spanfunc() {
        if ( !(Game.getInstance().renderer.detailshift) ) {
            R_DrawSpan();
        } else {
            R_DrawSpanLow();
        }
...
//    #endif 
    ...
    public void R_FillBackScreen() {
        ...
        Screen dest = Game.getInstance().video.screens[1];
        int destIndex = 0;
    ...
    { 
      ...
      //  at one point.
        ...
        Video video = Game.getInstance().video;
        Screen a = video.screens[0];
        Screen b = video.screens[1];
