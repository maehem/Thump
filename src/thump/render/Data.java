...
//        Z_Free(names);
        ...
        ArrayList<Patch> patches = wad.patchesLump.getPatches();
...
//        //textureheight = Z_Malloc (numtextures*4, PU_STATIC, 0);
        textureheight = new int[Game.getInstance().wad.getTextures().size() * 4];
...
//        }
    ...
    //    W_ReadLump (lump,colormaps); 
        colormaps = Game.getInstance().wad.getColorMaps();
    }
