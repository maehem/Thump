            ...
            for (i=0 ; i<doomcom.numnodes ; i++) {
                if (nodeingame[i])
                {
                    ...
                    if (netbuffer.numtics > BACKUPTICS) {
                        ...
                        thump.base.Defines.logger.severe("NetUpdate: netbuffer.numtics > BACKUPTICS");
                    }
...
//        }
    ...
    public void D_CheckNetGame () {
        ...
        if (doomcom.id != DOOMCOM_ID) {
            ...
            thump.base.Defines.logger.severe("Doomcom buffer invalid!");
        }
...
//                     realtics, availabletics,counts);
        ...
        while (lowtic < Game.getInstance().gametic/ticdup + counts)	
        {
            ...
            if (lowtic < Game.getInstance().gametic/ticdup) {
                ...
                thump.base.Defines.logger.severe("TryRunTics: lowtic < gametic");
            }
        ...
        while (counts>0) {
            ...
            for (i=0 ; i<ticdup ; i++) {
                if (Game.getInstance().gametic/ticdup > lowtic) {
                    ...
                    thump.base.Defines.logger.severe("gametic>lowtic");
                }
