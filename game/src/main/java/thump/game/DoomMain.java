...
import static thump.game.Defines.DEVDATA;
import static thump.game.Defines.DEVMAPS;
import thump.game.Defines.GameMode;
import static thump.game.Defines.GameMode.COMMERCIAL;
import thump.game.Defines.GameState;
import static thump.game.Defines.GameState.GS_DEMOSCREEN;
import static thump.game.Defines.GameState.GS_LEVEL;
import static thump.game.Defines.SAVEGAMENAME;
import static thump.base.Defines.SCREENHEIGHT;
import static thump.base.Defines.SCREENWIDTH;
import thump.game.Defines.Skill;
import static thump.game.Defines.VERSION;
...
//TODO            debugfile = fopen(filename, "w");
    ...
    void D_Display () {
        ...
        if (game.renderer.setsizeneeded) {  // setsizein r_main
            game.renderer.R_ExecuteSetViewSize (game.renderer.video.screens[0]);
        ...
        if (game.gamestate == GS_LEVEL && oldgamestate != GS_LEVEL) {
            ...
            game.renderer.draw.R_FillBackScreen (
                    game.wad,
                    Game.getInstance().gameMode == COMMERCIAL  
