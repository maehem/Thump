...
import static thump.game.i18n.English.DETAILHI;
import static thump.game.i18n.English.DETAILLO;
import static thump.game.headup.Stuff.HU_FONTSIZE;
import static thump.game.headup.Stuff.HU_FONTSTART;
import static thump.game.menu.NewGameMenu.Items.*;
import static thump.game.menu.OptionsMenu.Items.detail;
import static thump.game.menu.OptionsMenu.Items.messages;
import static thump.game.menu.OptionsMenu.Items.mousesens;
import static thump.game.menu.OptionsMenu.Items.scrnsize;
import static thump.game.menu.SoundMenu.Items.music_vol;
import static thump.game.menu.SoundMenu.Items.sfx_vol;
...
//        }
    ...
    void M_DrawLoad() {
        ...
        game.renderer.video.drawPatchDirect(72, 28, 0, "M_LOADG", game.wad);
    ...
    void M_DrawSaveLoadBorder(int x, int y) {
        ...
        game.renderer.video.drawPatchDirect(x-8, y+7, 0, "M_LSLEFT", game.wad);        
        // video.drawPatchDirect(x - 8, y + 7, 0, W_CacheLumpName("M_LSLEFT", PU_CACHE));

        int xx = x;
        for (int i = 0; i < 24; i++) {
            game.renderer.video.drawPatchDirect(xx, y + 7, 0, "M_LSCNTR", game.wad);        
            //video.drawPatchDirect(x, y + 7, 0, W_CacheLumpName("M_LSCNTR", PU_CACHE));
            xx += 8;
        }

        game.renderer.video.drawPatchDirect(x, y + 7, 0, "M_LSRGHT", game.wad);        
    ...
    void M_DrawSave() {
        ...
        game.renderer.video.drawPatchDirect(72, 28, 0, "M_SAVEG", game.wad);
...
//            }
    ...
    void M_DrawReadThis1() {
        ...
        switch (game.gameMode) {
            case COMMERCIAL:
                game.renderer.video.drawPatchDirect(0, 0, 0, "HELP", game.wad);
                break;
            case SHAREWARE:
            case REGISTERED:
            case RETAIL:
                game.renderer.video.drawPatchDirect(0, 0, 0, "HELP1", game.wad);
                break;
            default:
                break;
        }
    ...
    void M_DrawReadThis2() {
        ...
        switch (game.gameMode) {
            ...
            case COMMERCIAL:
                ...
                game.renderer.video.drawPatchDirect(0, 0, 0, "CREDIT", game.wad);
                break;
            case SHAREWARE:
            case REGISTERED:
                game.renderer.video.drawPatchDirect(0, 0, 0, "HELP2", game.wad);
                break;
            default:
                break;
        }
    ...
    //
    void M_DrawSound() {
        game.renderer.video.drawPatchDirect(60, 38, 0, "M_SVOL", game.wad);
    ...
    //
    void M_DrawNewGame() {
        game.renderer.video.drawPatchDirect(96, 14, 0, "M_NEWG", game.wad);
        game.renderer.video.drawPatchDirect(54, 38, 0, "M_SKILL", game.wad);
    }
...
//
    ...
    void M_DrawEpisode() {
        game.renderer.video.drawPatchDirect(54, 38, 0, "M_EPISOD", game.wad);
    }
    ...
    void M_DrawOptions() {
        game.renderer.video.drawPatchDirect(108, 15, 0, "M_OPTTTL", game.wad);

        game.renderer.video.drawPatchDirect(
                optionsMenu.x + 175, 
                optionsMenu.y + LINEHEIGHT * detail.ordinal(), 
                0,
        ...
        game.renderer.video.drawPatchDirect(
                optionsMenu.x + 120, 
                optionsMenu.y + LINEHEIGHT * messages.ordinal(), 
                0,
...
//        }
    ...
    void M_DrawThermo(int _x,
        ...
        game.renderer.video.drawPatchDirect(xx, y, 0, "M_THERML", game.wad);
        xx += 8;
        for (i = 0; i < thermWidth; i++) {
            game.renderer.video.drawPatchDirect(xx, y, 0, "M_THERMM", game.wad);
            xx += 8;
        }
        game.renderer.video.drawPatchDirect(xx, y, 0, "M_THERMR", game.wad);

        game.renderer.video.drawPatchDirect((_x + 8) + thermDot * 8, y,
                0, "M_THERMO", game.wad);
    }
        ...
        if (!menuactive) {
            switch(ch) {
                ...
                case Defines.KEY_F11:           // gamma toggle
                    game.renderer.video.usegamma++;
                    if (game.renderer.video.usegamma > 4) {
                        game.renderer.video.usegamma = 0;
                    }
                    game.players[game.consoleplayer].message = gammamsg[game.renderer.video.usegamma];
...
public void M_Drawer () {
    ...
    if ( menuactive ) {
        BufferedImage screen = game.renderer.video.screenImage[0];
	...
	if (currentMenu.menuItems.get(i).name!=null) {
            game.renderer.video.drawPatchDirect (x,y,0,currentMenu.menuItems.get(i).name, game.wad);
        }
	y += LINEHEIGHT;
    }
