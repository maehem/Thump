            ...
            for (int i = 0; i < wad.numlumps; i++) {
                ...
                if ( name.startsWith("PLAYPAL") ) {
                    ...
                    if ( name.startsWith("S_END") ) {
                        ...
                        Patch pic = spritesLump.addSprite( fc, name, filePos, lumpSize );
                        //logger.config(pic.toString());
                    }
//                } else if ( name.startsWith("P_START") || name.startsWith("P_END") ) {
//                    // Do nothing.
//                    lump = null;
//                } else if ( name.startsWith("P1_START") ) {
//                    patchesLump1 = new PatchesLump(fc, name, filePos, lumpSize, wad.getPlayPalLump().paletteList);
//                    lump = patchesLump1;
//                    //logger.config(lump.toString());
//                } else if ( patchesLump1 != null ) {
//                    if ( name.startsWith("P1_END") ) {
//                        patchesLump1 = null;
//                        lump = null;
//                        //logger.config("End of Patches 1 lump.");
//                    } else {
//                        Patch pic = patchesLump1.addPatch( fc, name, filePos, lumpSize );
//                        //logger.config(pic.toString());
//                    }
//                } else if ( name.startsWith("P2_START") ) {
//                    patchesLump2 = new PatchesLump(fc, name, filePos, lumpSize, wad.getPlayPalLump().paletteList);
//                    lump = patchesLump2;
//                    //logger.config(lump.toString());
//                } else if ( patchesLump2 != null ) {
//                    if ( name.startsWith("P2_END") ) {
//                        patchesLump2 = null;
//                        lump = null;
//                        //logger.config("End of Patches 2 lump.");
//                    } else {
//                        Patch pic = patchesLump2.addPatch( fc, name, filePos, lumpSize );
//                        //logger.config(pic.toString());
//                    }
//                } else if ( name.startsWith("P3_START") ) {
//                    patchesLump3 = new PatchesLump(fc, name, filePos, lumpSize, wad.getPlayPalLump().paletteList);
//                    lump = patchesLump3;
//                    //logger.config(lump.toString());
//                } else if ( patchesLump3 != null ) {
//                    if ( name.startsWith("P3_END") ) {
//                        patchesLump3 = null;
//                        lump = null;
//                        //logger.config("End of Patches 3 lump.");
//                    } else {
//                        Patch pic = patchesLump3.addPatch( fc, name, filePos, lumpSize );
//                        //logger.config(pic.toString());
//                    }
/////////////////
                    ...
                    if ( name.startsWith("P_END") ) {
                        ...
                        Patch patch = patchesLump.addPatch( fc, name, filePos, lumpSize );
...
//                    //logger.config(lump.toString());
                    ...
                    try {
                        lump = new MusicLump(fc, name, filePos, lumpSize);
