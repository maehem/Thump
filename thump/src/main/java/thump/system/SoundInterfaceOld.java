/*
 * Sound Interface for System - should be the same for all systems under Java.
 */
 ...
 * @author mark
 */
public class SoundInterfaceOld {
...
//    #endif
    ...
    int 		lengths[] = new int[Sounds.SfxEnum.values().length];
    ...
    int	mixbuffer[] = new int[MIXBUFFERSIZE];
    ...
    Channel	channelsend[] = new Channel[NUM_CHANNELS];
    ...
    Sounds.SfxEnum channelids[] = new Sounds.SfxEnum[NUM_CHANNELS];
...
//        channelsend[slot] = channels[slot] + lengths[sfxid];
        ...
        channelstart[slot] = Game.getInstance().gametic;
        ...
        if (rightvol < 0 || rightvol > 127) {
            SystemInterface.I_Error("rightvol out of bounds");
        }

        if (leftvol < 0 || leftvol > 127) {
            SystemInterface.I_Error("leftvol out of bounds");
        }
...
//        channelrightvol_lookup[slot] = vol_lookup[rightvol*256];
    ...
    void I_SetChannels()
    {
        ...
        int[] steptablemid = Arrays.copyOfRange(steptable, 128, steptable.length);
...
//      snd_MusicVolume = volume;
    ...
    //
//    int I_GetSfxLumpNum(SfxInfo sfx) {
//        //char namebuf[9];
//        //sprintf(namebuf, "ds%s", sfx.name);
//        return W_GetNumForName("ds" + sfx.name);
//    }
...
//    #else
        ...
        id = addsfx( Sounds.SfxEnum.values()[id], vol, steptable[pitch], sep );
...
//    #endif
    ...
    boolean I_SoundIsPlaying(int handle) {
        // Ouch.
        return Game.getInstance().gametic < handle;
    }
