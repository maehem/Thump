...
import static thump.global.Defines.PowerType.pw_ironfeet;
...
import static thump.play.Ceiling.MAXCEILINGS;
import static thump.play.Ceiling.Type.*;
import static thump.play.Floor.FLOORSPEED;
import static thump.play.Floor.Type.*;
import static thump.play.Platform.MAXPLATS;
import static thump.play.Platform.Type.blazeDWUS;
import static thump.play.Platform.Type.downWaitUpStay;
import static thump.play.Platform.Type.perpetualRaise;
import static thump.play.Platform.Type.raiseToNearestAndChange;
import static thump.play.SpecialEffects.Stair.build8;
import static thump.play.SpecialEffects.Stair.turbo16;
...
public class SpecialEffects {  //  p_spec
    ...
    public static void P_PlayerInSpecialSector(Player player) {
        ...
        switch (sector.special) {
            ...
            default:
                SystemInterface.I_Error("P_PlayerInSpecialSector: unknown special {0}\n",
